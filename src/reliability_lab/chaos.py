...
def run_simulation(config: LabConfig, queries: list[str]) -> RunMetrics:
    ...
    for scenario in config.scenarios:
        ...
        # Define pass/fail criteria per scenario based on availability and fallback rates
        passed = False
        ...
        elif scenario.name == "backup_flaky_50":
            passed = result.availability >= 0.40
        else:
